...
const __mfImport = (src) =>
  globalThis.System && typeof globalThis.System.import === 'function'
    ...
    : import(src);
(async () => {
  const { initHost } = await __mfImport("https://pigeon9989.github.io/test2/assets/hostInit-DTQnY6O8.js");
  const runtime = await initHost();
  const __mfRemotePreloads = [];
  await Promise.all(__mfRemotePreloads);
})().then(() => __mfImport("https://pigeon9989.github.io/test2/assets/index-Cdgv9t4_.js"));
